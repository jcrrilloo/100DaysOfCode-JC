...
function testEight(favoriteDrink){
    return "Favorite Drink: " + favoriteDrink;
}
function testNine(gender){
...
console.log(testFour("Anaheim"));
console.log(testFive(27));
console.log(testSix("Libra"));
console.log(testSeven("Tacos"));
console.log(testEight("Coffee"));
console.log(testNine("Male"));
console.log(testTen("5'10"));
```
